...
try {
    ...
    $sql = "
        ...
        FROM (
            ...
            SELECT po.ORDER_NO, po.LINE_NO, po.RELEASE_NO, po.STATE, po.BUY_QTY_DUE, po.BUY_QTY_DUE as BALANCE, o.ORDER_DATE
            ...
            SELECT po.ORDER_NO, po.LINE_NO, po.RELEASE_NO, po.STATE, po.BUY_QTY_DUE, (po.BUY_QTY_DUE - NVL(h.QTY_ARRIVED, 0)) as BALANCE, o.ORDER_DATE
            FROM IFSAPP.PURCHASE_ORDER_LINE_ALL po
            INNER JOIN IFSAPP.PURCHASE_REQUISITION r ON po.REQUISITION_NO = r.REQUISITION_NO AND po.CONTRACT = r.CONTRACT
            INNER JOIN IFSAPP.PURCHASE_ORDER o ON po.ORDER_NO = o.ORDER_NO
            LEFT JOIN (
